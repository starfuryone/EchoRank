...
const MIGRATED = [
  ...
  ["keywords-explorer", KEYWORDS_EXPLORER_HELP_COPY, ["whatTitle", "readingTitle", "readDifficulty",
    "readRelevance", "readSource", "groupsTitle", "groupTopics", "groupQuestions", "groupSerp",
    "actionsTitle", "actionsLink", "finderTitle", "finderLink"]],
