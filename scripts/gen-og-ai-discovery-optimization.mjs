// Generates public/og/ai-discovery-optimization.png (1200x630) — the Open
// Graph card for /[locale]/ai-discovery-optimization.
//
//   node scripts/gen-og-ai-discovery-optimization.mjs
//
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <!-- title. Two lines: "AI Discovery Optimization" on one line runs past the
       1200px edge in DejaVu, which is wider than the site's Geist. -->
  <text x="80" y="330" font-family="${FONT}" font-size="76" font-weight="bold" fill="#ffffff">AI Discovery</text>
  <text x="80" y="420" font-family="${FONT}" font-size="76" font-weight="bold" fill="url(#gold)">Optimization</text>

  <!-- subtitle -->
  <text x="80" y="500" font-family="${FONT}" font-size="28" fill="${MUTED}">The Echorank AIDO Guide</text>
...
const out = path.join(root, "public", "og", "ai-discovery-optimization.png");
