...
const keywordsEn = {
  ...
  colActions: "Actions",
  colSource: "Source",
  sourceTitle: "Strongest place this phrase appears on your pages",
  fieldLabels: { title: "Title", h1: "H1", h2: "H2", h3: "H3", meta: "Meta", alt: "Alt text", anchor: "Link text", body: "Body" } as Record<string, string>,
  relevanceNa: "—",
...
export const KEYWORDS_COPY: Record<DashLocale, KeywordsCopy> = {
  ...
  fr: {
    ...
    colActions: "Actions",
    colSource: "Source",
    sourceTitle: "L'endroit le plus marquant où cette expression apparaît sur vos pages",
    fieldLabels: { title: "Titre", h1: "H1", h2: "H2", h3: "H3", meta: "Méta", alt: "Texte alt", anchor: "Texte de lien", body: "Corps" } as Record<string, string>,
    relevanceNa: "—",
  ...
  "de-CH": {
    ...
    colActions: "Aktionen",
    colSource: "Quelle",
    sourceTitle: "Die stärkste Stelle, an der diese Phrase auf Ihren Seiten vorkommt",
    fieldLabels: { title: "Titel", h1: "H1", h2: "H2", h3: "H3", meta: "Meta", alt: "Alt-Text", anchor: "Linktext", body: "Fliesstext" } as Record<string, string>,
    relevanceNa: "—",
