...
const reviewLinksEn = {
  ...
  helpModal: {
    ...
    importIntro: "To pull your current Google, Facebook, or Trustpilot reviews into Echorank360, use the browser extension. Download it and follow the install steps here:",
...
export const REVIEW_LINKS_COPY: Record<DashLocale, ReviewLinksCopy> = {
  ...
  fr: {
    ...
    helpModal: {
      ...
      importIntro: "Pour importer vos avis Google, Facebook ou Trustpilot dans Echorank360, utilisez l'extension de navigateur. Téléchargez-la et suivez les étapes d'installation ici :",
  ...
  "de-CH": {
    ...
    helpModal: {
      ...
      importIntro: "Um Ihre aktuellen Google-, Facebook- oder Trustpilot-Bewertungen in Echorank360 zu übernehmen, verwenden Sie die Browser-Erweiterung. Laden Sie sie herunter und folgen Sie den Installationsschritten hier:",
