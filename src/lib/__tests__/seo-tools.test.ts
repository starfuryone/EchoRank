...
test('"New" badges exactly on AI Attribution, AI Lens, Bot Analytics, GBP Monitor, Historical and Share of Voice', () => {
...
test("the live/coming-soon split is what the marketing copy claims", () => {
  ...
  assert.equal(ALL_TOOLS.length, 26, "tool count changed");
  assert.equal(live.length, 22, "live tool count changed — update the homepage copy");
