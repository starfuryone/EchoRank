...
test('"New" badges exactly on AI Attribution, AI Lens, Bot Analytics, Citation Finder, GBP Monitor, Historical and Share of Voice', () => {
...
test("the live/coming-soon split is what the marketing copy claims", () => {
  ...
  assert.equal(ALL_TOOLS.length, 27, "tool count changed");
  assert.equal(live.length, 23, "live tool count changed — update the homepage copy");
