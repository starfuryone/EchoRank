/**
 * GET /api/seo/v1/site-audit/[id] — one audit. This is the endpoint the UI
 * polls every 10 s while a crawl is running, so it must stay cheap: it only
 * reads the row the worker is updating.
 *
...
import { toAuditDto } from "@/lib/site-audit/service";
