/**
 * GET /api/seo/v1/site-explorer/[id] — one stored analysis, for the history
...
import { toAnalysisDto } from "@/lib/site-explorer/service";
...
export async function GET(
  ...
  try {
    ...
    const row = await prisma.siteExplorerAnalysis.findFirst({
