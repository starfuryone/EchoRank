...
const T = {
  en: {
    ...
    pricing: {
      ...
      tiers: [
        { n: "STARTER", a: "$49", hi: false, f: ["Review campaigns (email, SMS, QR)", "Private feedback & routing", "Multi-source review monitoring", "AI response drafting"] },
        { n: "GROWTH", a: "$149", hi: true, f: ["Everything in Starter", "AI Visibility Auditor + fix roadmap", "Reputation Risk Score & alerts", "Revenue-at-risk"] },
        { n: "AGENCY", a: "$349", hi: false, f: ["Everything in Growth", "AI answer tracking (daily)", "Competitor momentum monitoring", "White-label & multi-client"] },
        { n: "ENTERPRISE", a: "$999", hi: false, f: ["Unlimited everything", "Custom volume", "SSO / SAML", "99.9% SLA"] },
      ],
  ...
  fr: {
    ...
    pricing: {
      ...
      tiers: [
        { n: "STARTER", a: "49 $", hi: false, f: ["Campagnes d'avis (courriel, SMS, QR)", "Rétroaction privée et routage", "Surveillance d'avis multi-sources", "Rédaction de réponses par IA"] },
        { n: "GROWTH", a: "149 $", hi: true, f: ["Tout Starter", "Auditeur de visibilité IA + feuille de route", "Score de risque réputationnel et alertes", "Revenu à risque"] },
        { n: "AGENCY", a: "349 $", hi: false, f: ["Tout Growth", "Suivi des réponses IA (quotidien)", "Surveillance de la vélocité concurrente", "Marque blanche et multi-clients"] },
        { n: "ENTERPRISE", a: "999 $", hi: false, f: ["Tout illimité", "Volume sur mesure", "SSO / SAML", "SLA 99,9 %"] },
      ],
