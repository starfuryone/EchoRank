...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return { title: `${TITLE} | EchoRank`, description: DESC };
}
...
export default async function GuideIaPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const chapters: [string, string][] = [
    ...
    ["analyse", "7. Ce que nous avons analysé"],
    ["secteurs", "8. Guides par secteur d'activité"],
    ["glossaire", "9. Glossaire de la visibilité IA"],
  ...
  return (
    <div className={s.page}>
      ...
      <div className={s.wrap}>
        <div className={s.top}>
          <Link href={`/${locale}`} aria-label="EchoRank 360, accueil">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/echorank-logo-dark.svg" alt="ECHORANK 360" className={s.logo} />
          </Link>
          <Link href="/register">Audit de visibilité IA →</Link>
        </div>
        ...
        {/* 7 ─────────────────────────────────────────────────────────── */}
        <h2 id="analyse" className={s.h2}>7. Ce que nous avons analysé</h2>
        ...
        {/* 8 ─────────────────────────────────────────────────────────── */}
        <h2 id="secteurs" className={s.h2}>8. Guides par secteur d'activité</h2>
        ...
        {/* 9 ─────────────────────────────────────────────────────────── */}
        <h2 id="glossaire" className={s.h2}>9. Glossaire de la visibilité IA</h2>
        ...
        {/* 10 ────────────────────────────────────────────────────────── */}
        <h2 id="faq" className={s.h2}>10. Questions fréquentes</h2>
        {FAQ.map(([q, a]) => (
          <div key={q}>
