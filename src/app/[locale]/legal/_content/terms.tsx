// Terms of Use body. Shared by the /legal/terms route and the consent modal.
...
export const buildTerms = (locale: string): LegalDoc =>
  locale.startsWith("fr") ? buildFr(locale) : buildEn(locale);
