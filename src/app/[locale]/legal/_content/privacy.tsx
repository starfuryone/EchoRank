// Privacy Policy body. Shared by the /legal/privacy route and the consent modal.
...
/** Description falls back to the opening paragraph, which is plain text here. */
function withDescription(d: LegalDoc): LegalDoc {
  const first = d.sections[0]?.ps[0];
  return { ...d, description: typeof first === "string" ? first : d.title };
}

export const buildPrivacy = (locale: string): LegalDoc =>
  withDescription(locale.startsWith("fr") ? FR : EN);
