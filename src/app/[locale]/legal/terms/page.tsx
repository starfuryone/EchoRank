...
const EN: Doc = {
  ...
  sections: [
    ...
    { h: "5. AI features and no guarantee of results", ps: [
    ...
    { h: "8. Suspension and termination", ps: [
    ...
    { h: "9. Disclaimer of warranties", ps: [
    ...
    { h: "10. Limitation of liability", ps: [
    ...
    { h: "12. Governing law and disputes", ps: [
    ...
    { h: "13. Changes to these Terms", ps: [
...
const FR: Doc = {
  ...
  sections: [
    ...
    { h: "2. Abonnements, essai et facturation", ps: [
      "Les forfaits sont facturés d'avance, de façon récurrente, aux prix affichés lors de l'achat. Les nouveaux comptes bénéficient d'un essai gratuit de 14 jours ; aucune carte n'est requise pour l'essai et rien n'est facturé sans souscription.",
    ...
    { h: "5. Fonctions d'IA et absence de garantie de résultats", ps: [
    ...
    { h: "7. Propriété intellectuelle", ps: [
    ...
    { h: "8. Suspension et résiliation", ps: [
    ...
    { h: "10. Limitation de responsabilité", ps: [
    ...
    { h: "12. Droit applicable et litiges", ps: [
    ...
    { h: "13. Modification des Conditions", ps: [
    ...
    { h: "14. Dispositions générales", ps: [
