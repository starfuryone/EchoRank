...
import { VISIBILITY_HELP_COPY, type DashLocale } from "@/lib/i18n/dashboard";
 ...
 */
export function VisibilityHelpButton({ locale = "en" }: { locale?: DashLocale }) {
  const t = VISIBILITY_HELP_COPY[locale];
  ...
  return (
    <div className="flex flex-none items-center gap-2">
      ...
      >
        ...
        <KnowledgeBaseLinks locale={locale} route="/visibility" />
      </Modal>
    </div>
  );
}
