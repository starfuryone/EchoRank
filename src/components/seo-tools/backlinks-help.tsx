...
// Backlinks page help: outlined "Help" button beside the primary action,
// opening the shared Modal — the pattern established by Review Links and
// followed by Rank Tracker.
//
    ...
    <>
      ...
      >
        <div className="space-y-5 pb-1">
          ...
          <Entry title={t.backlinksTitle} body={t.backlinksBody} />
          <Entry title={t.dofollowTitle} body={t.dofollowBody} />
          <Entry title={t.anchorsTitle} body={t.anchorsBody} />
          <Entry title={t.historyTitle} body={t.historyBody} />

          {/* Index freshness is a caveat, not a step — it explains why this
              tool and any other backlink checker will disagree slightly. */}
          <div className="rounded-lg border border-blue-100 bg-blue-50 px-3 py-2">
            <h3 className="text-xs font-semibold text-blue-900">{t.freshnessTitle}</h3>
            <p className="mt-1 text-xs leading-relaxed text-blue-800">{t.freshnessBody}</p>
          </div>
        </div>
      </Modal>
    </>
