...
export default auth((req) => {
  ...
  if (/^\/(en|en-CA|fr|fr-CA|de-CH)\/(ai-visibility|reputation-risk|customer-feedback|reputation-engine|how-to|live-monitoring|act-on-signals|guide|guide-visibilite-ia|legal\/(privacy|terms|disclaimer))\/?$/.test(pathname)) {
    return NextResponse.next();
  }
